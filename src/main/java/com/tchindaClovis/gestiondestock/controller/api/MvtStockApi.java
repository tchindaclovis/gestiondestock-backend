...
public interface MvtStockApi {
    ...
    @Operation(
            summary = "Supprimer un mvtStock",
            description = "Cette méthode permet de supprimer un mvtStock par son ID",
            responses = {
                @ApiResponse(responseCode = "200", description = "Le mvtStock a été supprimé")
            }
    )
